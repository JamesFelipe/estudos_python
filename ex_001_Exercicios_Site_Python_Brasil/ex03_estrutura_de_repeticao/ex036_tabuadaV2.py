...
"""
numero = int(input('Número para montar a tabuada: '))
comeco = int(input('Digite o número de início: '))
fim = int(input('Digite o número do fim: '))
if comeco < fim:
    print('Desculpe, não posso usar um valor final maior que o inicial...Programa Encerrado.')
else:
